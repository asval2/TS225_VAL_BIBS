...
for i=B3(1,1):B3(2,1)
    for j=B3(1,2):B3(2,2)
        ...
        %if(ismember(i,[B1(1,1):B1(2,1)])&&ismember(j,[B1(2,1):B1(2,2)]))
         if(i>=B1(1,1) && i<=B1(2,1) && j>=B1(1,2) &&  j<=B1(2,2))
            a=Mask1(j-B1(1,2)+1,i-B1(1,1)+1);
            I3(j,i,:)=I3(j,i,:)+a*I1(j-B1(1,2)+1,i-B1(1,1)+1,:);
            
            
         end
        
        %if(ismember(i,[B2(1,1):B2(2,1)])&&ismember(j,[B2(1,1):B2(2,1)]))
        if(i>=B2(1,1) && i<=B2(2,1) && j>=B2(1,2) &&  j<=B2(2,2))
%             j-B2(1,2)
            b=Mask2(j-B2(1,2)+1,i-B2(1,1)+1);
            I3(j,i,:)=I3(j,i,:)+b*I2(j-B2(1,2)+1,i-B2(1,1)+1,:);
